...
<link rel="stylesheet" href="css/search_page.css?date=201804192" />
<link rel="stylesheet" href="css/giver_card_step1.css?date=201804191" />
<style>
.card .img_box.slick-dotted.slick-slider {
	margin-bottom: 0px;
}

#menuFilter .tui-datepicker {
	z-index: 110;
}
</style>
</head>
<body>
	...
	<div id="menuContents">
		...
		<div id="menucard">
			...
			<!-- box_card-->
			<div class='paginate'>
				<span title="이전 페이지 없음"><i class="fas fa-caret-left"></i></span> <strong
					href="" title='현재 1페이지'>1</strong> <a href="" title='2'>2</a> <a
					href="" title='3'>3</a> <a href="" title='4'>4</a> <a href=""
					title='5'>5</a> <a href="" title='다음 페이지로'> <i
    ...
    <div class="card" >
        ...
        <div class="content" onclick="javascript:location.href='details_giver.jsp'">
            <ul>
	...
	<script src="js/giver_card_step1.js?date=201804191"></script>
