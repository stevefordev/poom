						...
						<form id="joinContent" method="post" action="signup.jsp">
							<div class="input_box" id="nameBox">
								...
								<div class="alert_box" id="nameAlert">
									<span class="msg good">완벽한 이름이네요!</span> <span class="msg bad">한글과
										영문 대 소문자를 2~15글자 이내로 사용하세요.</span>
								</div>
							...
							<div class="input_box" id="passwordBox">
								...
								<div class="alert_box" id="passwordAlert">
									<span class="msg good">좋은 비밀번호입니다.</span> <span class="msg bad">영문,숫자,특수문자를
										혼용하여 8~16자를 입력해주세요.</span>
								</div>
							</div>
